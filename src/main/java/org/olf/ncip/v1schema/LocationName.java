...
public class LocationName {
    ...
    /**
     * Gets the value of the locationNameInstance property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the locationNameInstance property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getLocationNameInstance().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<LocationNameInstance> getLocationNameInstance() {
        if (locationNameInstance == null) {
            locationNameInstance = new ArrayList<LocationNameInstance>();
        }
