...
public class LookupAgency {
    ...
    protected List<AgencyElementType> agencyElementType;
     ...
     * {@link AgencyElementType }
     * 
     * 
     */
    public List<AgencyElementType> getAgencyElementType() {
        if (agencyElementType == null) {
            agencyElementType = new ArrayList<AgencyElementType>();
        }
